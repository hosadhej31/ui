...
function library:CreateWindow(name,accentcolor,accentcolor2,textsize,sizeX,sizeY,backimage,hidebutton)
    ...
    FPSLabel.Text = " "..name.." | "..gamen.." | Fetching FPS.."
    FPSLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
    FPSLabel.TextSize = 15.000
    FPSLabel.TextStrokeTransparency = 0.000
    FPSLabel.TextXAlignment = Enum.TextXAlignment.Left
    
    FPSLabel.Size = UDim2.new(0, FPSLabel.TextBounds.X+10, 0, 25)
    ...
    game.TweenService:Create(Main, TweenInfo.new(0.7, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {
        Size = UDim2.new(0, FPSLabel.TextBounds.X+4, 0, 25)
    }):Play()
    ...
    FPSLabel.Text = " "..name.." | "..gamen.." | " .. math.floor(CurrentFPS) .." FPS"
    FPSLabel.Size = UDim2.new(0, FPSLabel.TextBounds.X+10, 0, 25)
    Main.Size = UDim2.new(0, FPSLabel.TextBounds.X+6, 0, 25)
    ...
    function window:CreateTab(name)
        ...
        function tab:CreateSector(name,side)
            ...
            sector.Label.TextSize = window.textsize
            ...
            function sector:AddButton(text, callback)
                ...
                button.Label.TextSize = window.textsize
            ...
            function sector:AddLabel(text)
                ...
                label.Main.TextSize = window.textsize
            ...
            function sector:AddToggle(text,default, callback)
                ...
                toggle.Main.TextSize = window.textsize + 1
                ...
                toggle.Label.TextSize = window.textsize
                ...
                function toggle:AddKeybind(default)
                    ...
                    keybind.Main.TextSize = window.textsize
            ...
            function sector:AddTextbox(text,default,callback)
                ...
                textbox.Main.TextSize = window.textsize
            ...
            function sector:AddSlider(text,min,default,max,decimals,callback)
                ...
                slider.Label.TextSize = window.textsize
            ...
            function sector:AddColorpicker(text, default, callback)
                ...
                colorpicker.Label.TextSize = window.textsize
            ...
            function sector:AddKeybind(text,default,newkeycallback,callback)
                ...
                keybind.Bind.TextSize = window.textsize + 1
            ...
            function sector:AddDropdown(text,items,default,callback)
                ...
                dropdown.Label.TextSize = window.textsize
                ...
                dropdown.Main.TextSize = window.textsize + 1
                ...
                dropdown.SelectedLabel.TextSize = window.textsize
